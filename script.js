...
function buyWeapon() {
	if (currentWeaponIndex < weapons.length - 1) {
		...
		text.innerText = 'You already have the most powerful awesome weapon!';
...
function getMonsterAttackValue(level) {
	...
	console.log(hit);
	// the following returns a ternary operator, syntax: condition ? expressionIfTrue : expressionIfFalse
	return hit > 0 ? hit : 0;
}
function dodge() {
